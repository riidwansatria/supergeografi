                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current ? 'flex text-primary hover:bg-gray-1' : 'text-gray-6 hover:bg-gray-1',
              ...
              <div className="px-2 pt-2 pb-3 space-y-1">
                {navigation.map((item) => (
                  <Link
                    ...
                    to={item.to}
                    className={classNames(
                      item.current ? 'flex text-primary hover:bg-gray-1' : 'flex text-gray-8 hover:bg-gray-1',
